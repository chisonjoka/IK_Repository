...
require('../functions/config.php');
 ...
 if(isset($_POST['fname'])){
	...
	if($len > 0){
		...
		$queri = "INSERT INTO contacts(contaid, cell, tell, email) VALUES(NULL,'$cel','$tel','$email')";
		$dbConnection -> query($queri) or die (mysqli_error());
		...
		$dbConnection -> query($query) or die (mysqli_error());
